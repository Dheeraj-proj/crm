...
urlpatterns = [
    ...
    path('customer/<str:numb>/', views.customer, name="customer"),

    path('account/', views.accountSettings, name="account"),

    path('create_order/<str:yo>', views.createorder, name="create_order"),
    path('update_order/<str:yo>/', views.updateorder, name="update_order"),
    path('delete_order/<str:yo>/', views.deleteorder, name="delete_order"),
